...
export default class Calendar extends React.Component {
    ...
    renderDays() {
        ...
        // console.log(dateFns.startOfWeek(new Date()));
        for (let i = 0; i < 7; i++) {
            days.push(
        ...
        // console.log(dateFns.addDays(startDate, 1));
        // console.log(dateFns.format(dateFns.addDays(startDate, 1), dateFormat));
    ...
    renderCells() {
        ...
        while (day <= endDate) {
            ...
            // Putting into the row after pushing all days of the week.
            rows.push(
